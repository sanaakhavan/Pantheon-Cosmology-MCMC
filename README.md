...
## Overview
This project performs parameter estimation for cosmological models using the **Pantheon Type Ia Supernovae dataset**. By fitting theoretical models to observational data, we estimate two fundamental cosmological parameters in a flat ΛCDM universe:
